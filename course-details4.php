...
<!-- <div class="social-icons">
        ...
        <div class="heading">
            <div class="container">
                <div class="row d-flex justify-content-center text-center">
                    <div class="col-lg-8">
                        <h1>Fellowship in Cosmetology & Trichology</h1>
    ...
    <section id="courses-course-details" class="courses-course-details section">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <img src="assets/img/skin.jpeg" class="img-fluid" alt="">
                    <h3>Fellowship in Cosmetology & Trichology</h3>
                    <p>
                        This 90-day course provides unlimited hands-on training with online/offline theory. Learn skin and hair basics to advanced treatments like facials, PRP, lasers, Botox, fillers, acne care, and pigmentation. It includes business strategies, consultation training, and lifetime support to launch your practice.
                </div>
                <div class="col-lg-4">

                    <div class="course-info d-flex justify-content-between align-items-center">
                        <h5>Eligibility</h5>
                        <p>MBBS,BDS,BAMS,BHMS</p>
                    </div>
                    ...
                    <div class="course-info d-flex justify-content-between align-items-center">
                        <h5>Instructor</h5>
                        <p>Dr. Reena Jain &<br> Dr. Neeraj Bansal</p>
                    </div>
